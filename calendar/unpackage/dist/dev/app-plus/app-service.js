    ...
    (function(root, factory) {
        ...
        var _fromYmdHms = function(y, m, d, hour, minute, second) {
          ...
          return {
            ...
            getFestivals: function() {
              var l = [];
              var f = SolarUtil2.FESTIVAL[this._p.month + "-" + this._p.day];
              if (f) {
                l.push(f);
              }
              var weeks2 = Math.ceil(this._p.day / 7);
              var week = this.getWeek();
              f = SolarUtil2.WEEK_FESTIVAL[this._p.month + "-" + weeks2 + "-" + week];
              if (f) {
                l.push(f);
              }
              if (this._p.day + 7 > SolarUtil2.getDaysOfMonth(this._p.year, this._p.month)) {
                f = SolarUtil2.WEEK_FESTIVAL[this._p.month + "-0-" + week];
                if (f) {
                  l.push(f);
                }
              }
            ...
            getXingZuo: function() {
              ...
              return SolarUtil2.XINGZUO[index];
            },
            toYmd: function() {
      ...
      var Lunar2 = /* @__PURE__ */ function() {
        ...
        var _computeYear = function(o, solar, year) {
          ...
          var liChun = o["jieQi"][I18n2.getMessage("jq.liChun")];
        ...
        var _computeMonth = function(o, solar) {
          ...
          var i;
          var end;
          var size = LunarUtil2.JIE_QI_IN_USE.length;
          var index = -3;
          for (i = 0; i < size; i += 2) {
            end = o.jieQi[LunarUtil2.JIE_QI_IN_USE[i]];
            var ymd = solar.toYmd();
          ...
          var offset2 = ((o.yearGanIndexByLiChun + (index < 0 ? 1 : 0)) % 5 + 1) * 2 % 10;
          o["monthGanIndex"] = ((index < 0 ? index + 10 : index) + offset2) % 10;
          o["monthZhiIndex"] = ((index < 0 ? index + 12 : index) + LunarUtil2.BASE_MONTH_ZHI_INDEX) % 12;
          start = null;
          index = -3;
          for (i = 0; i < size; i += 2) {
            end = o.jieQi[LunarUtil2.JIE_QI_IN_USE[i]];
          ...
          offset2 = ((o.yearGanIndexExact + (index < 0 ? 1 : 0)) % 5 + 1) * 2 % 10;
          o["monthGanIndexExact"] = ((index < 0 ? index + 10 : index) + offset2) % 10;
          o["monthZhiIndexExact"] = ((index < 0 ? index + 12 : index) + LunarUtil2.BASE_MONTH_ZHI_INDEX) % 12;
        };
        ...
        var _new = function(year, month, day, hour, minute, second, solar, ly) {
          ...
          return {
            ...
            getFestivals: function() {
              var l = [];
              var f = LunarUtil2.FESTIVAL[this._p.month + "-" + this._p.day];
              if (f) {
                l.push(f);
              }
            ...
            _getYearNineStar: function(yearInGanZhi) {
              ...
              var index = LunarUtil2.getJiaZiIndex(this.getYearInGanZhi()) + 1;
            ...
            getTimeNineStar: function() {
              ...
              return NineStar2.fromIndex(index % 9);
            },
            getSolar: function() {
            ...
            getWuHou: function() {
              ...
              return LunarUtil2.WU_HOU[(jq.index * 3 + index) % LunarUtil2.WU_HOU.length];
            },
            getHou: function() {
              var jieQi = this.getPrevJieQi(true);
                ...
                while (0 !== n) {
                  ...
                  if (month !== weekMonth) {
                    ...
                    if (plus2) {
                      ...
                      var size = SolarUtil2.getWeeksOfMonth(week.getYear(), week.getMonth(), start2);
                      if (size === index) {
        ...
        var _fromYm = function(y, m) {
          ...
          return {
            ...
            getMonths: function() {
              ...
              for (var i = 0; i < 3; i++) {
                l.push(SolarMonth2.fromYm(this._p.year, 3 * index + i + 1));
              }
              return l;
            },
            toString: function() {
        ...
        var _fromYm = function(y, m) {
          ...
          return {
            ...
            getMonths: function() {
              ...
              var index = this.getIndex() - 1;
              for (var i = 0; i < 6; i++) {
                l.push(SolarMonth2.fromYm(this._p.year, 6 * index + i + 1));
              }
              return l;
            },
            toString: function() {
        ...
        var _fromYear = function(lunarYear) {
          ...
          return {
            ...
            _getZaoByGan: function(index, name) {
              var offset2 = index - Solar2.fromJulianDay(this.getMonth(1).getFirstJulianDay()).getLunar().getDayGanIndex();
              if (offset2 < 0) {
                offset2 += 10;
              }
            ...
            _getZaoByZhi: function(index, name) {
              var offset2 = index - Solar2.fromJulianDay(this.getMonth(1).getFirstJulianDay()).getLunar().getDayZhiIndex();
              if (offset2 < 0) {
                offset2 += 12;
              }
              return name.replace("几", LunarUtil2.NUMBER[offset2 + 1]);
            ...
            getNineStar: function() {
              var index = LunarUtil2.getJiaZiIndex(this.getGanZhi()) + 1;
              var yuan = Math.floor((this._p.year + 2696) / 60) % 3;
              var offset2 = (62 + yuan * 3 - index) % 9;
              if (0 === offset2) {
                offset2 = 9;
              }
              return NineStar2.fromIndex(offset2 - 1);
            ...
            _compute: function() {
              ...
              for (i = 0, j = LunarUtil2.JIE_QI_IN_USE.length; i < j; i++) {
                if (i === 0) {
                  jd = ShouXingUtil2.qiAccurate2(jq[0] - 15.2184);
                } else if (i <= 26) {
                  jd = ShouXingUtil2.qiAccurate2(jq[i - 1]);
                } else {
                  jd = ShouXingUtil2.qiAccurate2(jq[25] + 15.2184 * (i - 26));
                }
              ...
              for (i = 0; i < 15; i++) {
                ...
                this._p.months.push(LunarMonth2._(y, mc, dayCounts[i], hs[i] + Solar2.J2000, index));
                index++;
              }
              return this;
            }
              ...
              if (0 === n) {
                ...
                if (n > 0) {
                  while (true) {
                    ...
                    rest -= more;
                    var lastMonth = months2[size - 1];
                    iy = lastMonth.getYear();
                    im = lastMonth.getMonth();
                    ny++;
                    months2 = LunarYear2.fromYear(ny).getMonths();
                  }
                  return months2[index2 + rest];
                } else {
                  while (true) {
                    size = months2.length;
                    for (i = 0; i < size; i++) {
      ...
      var ShouXingUtil2 = function() {
        ...
        return {
          ...
          saLonT2: function(w) {
            ...
            t += (w - ShouXingUtil2.eLon(t, 8) - Math.PI + (20.5 + 17.2 * Math.sin(2.1824 - 33.75705 * t)) / this.SECOND_PER_RAD) / v;
            return t;
          },
          msaLonT2: function(w) {
            var t;
          ...
          calcShuo: function(jd) {
            ...
            if (jd < f1 || jd >= f3) {
              ...
              var from2 = Math.floor((jd - f2) / 29.5306);
          ...
          calcQi: function(jd) {
            ...
            if (jd < f1 || jd >= f3) {
              ...
              var from2 = Math.floor((jd - f2) / 365.2422 * 24);
        ...
        var _fromLunar = function(lunar2) {
          return {
            ...
            _getDiShi: function(zhiIndex) {
              ...
              var index = offset2 + (this.getDayGanIndex() % 2 === 0 ? zhiIndex : -zhiIndex);
              if (index >= 12) {
                index -= 12;
              }
              if (index < 0) {
              ...
              return LunarUtil2.CHANG_SHENG[index];
            },
              ...
              var buildXiaoYun = function(daYun, index, forward2) {
                return {
                  ...
                  getGanZhi: function() {
                    ...
                    var size = LunarUtil2.JIA_ZI.length;
                    while (offset2 < 0) {
                      offset2 += size;
                    }
                    offset2 %= size;
        ...
        var _fromLunar = function(lunar2) {
          return {
            ...
            getFestivals: function() {
              ...
              var f = TaoUtil2.BA_JIE[jq];
              if (f) {
                l.push(TaoFestival.create(f));
              }
              f = TaoUtil2.BA_HUI[this._p.lunar.getDayInGanZhi()];
              if (f) {
                l.push(TaoFestival.create(f));
              }
              return l;
  ...
  const useCalendarStore = defineStore("calendar", () => {
    ...
    const monthDays = vue.computed(() => {
      ...
      while (day.isBefore(endDay, "day") || day.isSame(endDay, "day")) {
        const solar = lunarJavascript.Solar.fromYmd(day.year(), day.month() + 1, day.date());
        const lunar2 = solar.getLunar();
        let lunarText = lunar2.getDayInChinese();
        if (lunar2.getDay() === 1)
          lunarText = lunar2.getMonthInChinese() + "月";
        const festival = lunar2.getFestivals()[0] || lunar2.getOtherFestivals()[0];
        days2.push({
          date: day.clone(),
          day: day.date(),
    ...
    const debugSystem = async () => {
      ...
      formatAppLog("log", "at stores/calendar.js:277", debugLog.join("\n"));
    ...
    const loadEvents = async () => {
      try {
        ...
        const baseURL = getBaseURL();
        const url = baseURL + "/api/events?userId=default-user";
        formatAppLog("log", "at stores/calendar.js:386", "🌐 请求日程数据:", url);
        formatAppLog("log", "at stores/calendar.js:387", "📋 请求头:", getRequestHeaders());
        formatAppLog("log", "at stores/calendar.js:388", "🌍 当前环境:", isNgrokEnvironment() ? "Ngrok" : "本地");
        const response = await new Promise((resolve, reject) => {
          uni.request({
            url,
            method: "GET",
        ...
        const { statusCode, responseData } = handleUniResponse(response);
        formatAppLog("log", "at stores/calendar.js:409", "📡 响应状态:", statusCode);
        formatAppLog("log", "at stores/calendar.js:410", "📦 响应数据:", responseData);
        if (statusCode === 200) {
          if (Array.isArray(responseData)) {
            ...
            formatAppLog("warn", "at stores/calendar.js:421", "⚠️ 无法识别的数据格式");
            events.value = [];
          }
          formatAppLog("log", "at stores/calendar.js:425", `✅ 成功加载 ${events.value.length} 个日程`);
        } else {
          throw new Error(`HTTP错误: ${statusCode}`);
        }
      } catch (error) {
        formatAppLog("error", "at stores/calendar.js:430", "❌ 加载事件失败:", error);
        uni.showToast({
    ...
    const createEvent = async (eventData) => {
      try {
        ...
        formatAppLog("error", "at stores/calendar.js:475", "❌ 创建事件失败:", error);
        throw error;
      }
    };
    const updateEvent = async (eventId, eventData) => {
      try {
        ...
        formatAppLog("error", "at stores/calendar.js:510", "❌ 更新事件失败:", error);
        throw error;
      }
    };
    const deleteEvent = async (eventId) => {
      try {
        ...
        formatAppLog("error", "at stores/calendar.js:543", "❌ 删除事件失败:", error);
        throw error;
      }
    };
    return {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const handleSaveEvent = async () => {
        ...
        try {
          ...
          formatAppLog("error", "at pages/index/index.vue:498", "保存日程失败:", error);
          uni.showToast({
          ...
          success: async (res) => {
            if (res.confirm) {
              try {
                ...
                formatAppLog("error", "at pages/index/index.vue:522", "删除日程失败:", error);
                uni.showToast({
      ...
      vue.onMounted(() => {
        formatAppLog("log", "at pages/index/index.vue:551", "🚀 日历应用启动");
        setTimeout(() => {
          calendarStore.debugSystem().then(() => {
            formatAppLog("log", "at pages/index/index.vue:556", "🎯 系统调试完成，开始加载日程数据");
            calendarStore.loadEvents();
          }).catch((error) => {
            formatAppLog("error", "at pages/index/index.vue:560", "❌ 系统调试失败:", error);
            calendarStore.loadEvents();
          });
        }, 1e3);
        calendarStore.loadEvents();
              ...
              vue.renderList($setup.calendarStore.monthDays, (day, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  ...
                  vue.createElementVNode(
                    "text",
                    { class: "lunar-day" },
                    vue.toDisplayString(day.lunarDay),
                    1
                    /* TEXT */
                  ),
                  vue.createElementVNode("view", { class: "event-dots" }, [
                    (vue.openBlock(true), vue.createElementBlock(
                      vue.Fragment,
                      null,
